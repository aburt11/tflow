...
import { MilestonesPageComponent } from './Pages/milestones-page/milestones-page.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: '', component: HomePageComponent, data: {extraParameter: 'dashboardsMenu'}},

       {path: 'Pages/tasks', component: TasksPageComponent, data: {extraParameter: 'dashboardsMenu'}},

       {path: 'Pages/milestones', component: MilestonesPageComponent, data: {extraParameter: 'dashboardsMenu'}},

      {path: 'Pages/add-task', component: AddTaskPageComponent, data: {extraParameter: 'dashboardsMenu'}},
